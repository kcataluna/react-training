                    ...
                    <form onSubmit={(e) => e.preventDefault()}>
                        <fieldset disabled>
                            ...
                            <div className="form-group">
                                ...
                                <input type="text" className="form-control" placeholder="" value={this.props.id} />
                            </div>
                            <div className="form-group">
                                <label htmlFor="inputName">Name</label>
                                <input type="text" className="form-control" placeholder="" value={this.props.name} />
                            </div>
                            <div className="form-group">
                                <label htmlFor="inputBirthdate">Birthdate</label>
                                <input type="text" className="form-control" placeholder="" value={this.props.birthdate} />
                            </div>
                            <div className="form-group">
                                <label htmlFor="inputAddress">Address</label>
                                <input type="text" className="form-control" placeholder="" value={this.props.address} />
                            </div>
                        </fieldset>
                    </form>
                </div>
